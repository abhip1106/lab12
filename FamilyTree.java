...
public class FamilyTree {
	...
	private void addLine(String line) throws TreeException
	{
		...
		int colonIndex = ??; sshould be the index of the colon in line.
		if (colonIndex < 0) {
...
//		
//		  // Get nodes for input names. TreeNode node1 = root.??? // node whose name is
//		  name1 if (node1 == null) ??? Throw a TreeException with a useful message
//		  TreeNode node2 = root.??? // node whose name is name2 if (node2 == null) ???
//		  Throw TreeException with a useful message
//		  
//		  // Get ancestors of node1 and node2. ArrayList<TreeNode> ancestorsOf1 = ???
